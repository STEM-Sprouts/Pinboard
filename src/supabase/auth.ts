/**
 * Auth wrappers (supabase.md §1, ADR-0007). Google OAuth with a magic-link
 * fallback; everything degrades to "not configured" without env keys.
 * Sign-in exists for cloud save only — it is never the workshop critical
 * path, and a failure here must leave the local editor untouched.
 */
